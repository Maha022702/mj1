define(['jquery', 'Magezon_Builder/js/vimeo/player', 'Magezon_Builder/js/parallax', 'Magezon_Builder/js/responsive-typography', 'Magezon_Core/js/jquery.magnific-popup.min', 'waypoints'], function($, Vimeo) {
