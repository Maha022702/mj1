                ...
                value: function(u) {
                    ...
                    p.$video ? u(p.$video) : p.onAPIready(function() {
                        ...
                        if ("vimeo" === p.type) {
                            ...
                            p.player = p.player || new Vimeo(p.$video, p.playerOptions), p.options.startTime && p.options.autoplay && p.player.setCurrentTime(p.options.startTime), p.player.getVideoWidth().then(function(e) {
                                p.videoWidth = e || 1280
            ...
            if (t.isValid())
                if (e) {
                    if (t.on("ready", function() {
                        ...
                        }), o.video = t, !o.defaultInitImgResult)
