        ...
        (function(factory) {
            ...
            ko.extenders = {
                ...
                'deferred': function(target, options) {
                    ...
                    if (!target._deferUpdates) {
                        ...
                        target.limit(function(callback) {
                            var handle, ignoreUpdates = false;
                            return function() {
                                if (!ignoreUpdates) {
            ...
            ko.extenders['trackArrayChanges'] = function(target, options) {
                ...
                var trackingChanges = false,
                    cachedDiff = null,
                    arrayChangeSubscription, pendingNotifications = 0,
                    underlyingNotifySubscribersFunction, underlyingBeforeSubscriptionAddFunction = target.beforeSubscriptionAdd,
            ...
            function computedBeginDependencyDetectionCallback(subscribable, id) {
                ...
                if (!state.isDisposed) {
                    if (this.disposalCount && this.disposalCandidates[id]) {
                        ...
                        computedObservable.addDependencyTracking(id, subscribable, state.isSleeping ? {
            ...
            ko.bindingHandlers['options'] = {
                ...
                'update': function(element, valueAccessor, allBindings) {
                    ...
                    var selectWasPreviouslyEmpty = element.length == 0,
                        ...
                        captionValue, filteredArray, previousSelectedValues = [];
                    if (!valueAllowUnset) {
                        if (multiple) {
                ...
                ko.bindingHandlers['textInput'] = {
                    'init': function(element, valueAccessor, allBindings) {
                        var previousElementValue = element.value,
                            timeoutHandle, elementValueBeforeEvent;
                        ...
                        var deferUpdateModel = function(event) {
                            if (!timeoutHandle) {
                                ...
                                var handler = DEBUG ? updateModel.bind(element, {
                                    type: event.type
                                }) : updateModel;
            ...
            ko.utils.findMovesInArrayComparison = function(left, right, limitFailedCompares) {
                if (left.length && right.length) {
                    ...
                    for (failedCompares = l = 0;
                        (!limitFailedCompares || failedCompares < limitFailedCompares) && (leftItem = left[l]); ++l) {
            ...
            ko.utils.compareArrays = (function() {
                ...
                function compareSmallArrayToBigArray(smlArray, bigArray, statusNotInSml, statusNotInBig, options) {
                    var myMin = Math.min,
                        ...
                        thisRow, lastRow, bigIndexMaxForRow, bigIndexMinForRow;
