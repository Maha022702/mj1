        ...
        _removeNotAllowedAttributes: function(node) {
            ...
            while (treeWalker.nextNode()) {
                for (i = 0; i < treeWalker.currentNode.attributes.length; i++) {
                    ...
                    if (this.generallyAllowedAttributes.indexOf(attribute.name) === -1 || this.forbiddenAttributesByElement[nodeName] && this.forbiddenAttributesByElement[nodeName].indexOf(attribute.name) !== -1) {
