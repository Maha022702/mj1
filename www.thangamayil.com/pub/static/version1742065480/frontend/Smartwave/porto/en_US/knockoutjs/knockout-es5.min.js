...
(function(global, undefined) {
    ...
    function createPropertyDescriptor(originalValue, prop, map) {
        ...
        var observable = isObservable ? originalValue : isArray ? ko.observableArray(originalValue) : ko.observable(originalValue);
        map[prop] = function() {
            return observable;
        };
    ...
    function createLazyPropertyDescriptor(originalValue, prop, map) {
        ...
        map[prop] = function() {
            return getOrCreateObservable(originalValue);
        };
        return {
            configurable: true,
            enumerable: true,
